...
class TestHelper:
    ...
    def test_get_season(self):
        ...
        # Spring: Mar, Apr, May
        assert get_season(datetime(2023, 4, 15)) == Season.Spring.value
        # Autumn: Sep, Oct, Nov
        assert get_season(datetime(2023, 10, 15)) == Season.Autumn.value
    ...
    def test_calc_for_blocks_of_n(self):
        ...
        result = calc_for_blocks_of_n(data, n=24, func='mean')
    ...
    def test_tuple_list_from_hour_periods(self):
        ...
        # Handle nan/None
        assert tuple_list_from_hour_periods(None) == []
